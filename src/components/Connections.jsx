...
import { addSender } from "../utils/senderSlice";
      ...
      {connections &&
        connections.map((connection) => {
          ...
          return (
            <div
              key={_id}
              className="flex bg-base-300 shadow-xl w-5/12 h-32 rounded-xl mb-5"
            >
              <div className="mr-5">
                <figure className="">
                  <img
              ...
              <div className="flex justify-between w-full items-center">
                ...
                <Link to={"/chat/" + _id}>
                  <button
                    className="px-5 mx-5 btn btn-primary"
                    onClick={() => disptach(addSender(connection))}
                  >
                    Chat
                  </button>
                </Link>
